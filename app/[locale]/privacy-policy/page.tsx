...
const page = () => {
  return (
    <div className="max-w-2xl p-8 mx-auto">
      <h1 className="mb-8 text-4xl font-bold">Privacy Policy for Digithouse</h1>
      <p className="mb-4">
        At mmfontshub, accessible from https://www.mmfontshub.com/, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by
        mmfontshub and how we use it.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-6">
        ...
        to the information that they shared and/or collect in mmfontshub. This policy is not applicable to any
        information collected offline or via channels other than this website.
      </p>
      <h1 className="mb-6 text-3xl font-bold">Consent</h1>
      <p className="mb-6">By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
      <h1 className="mb-6 text-3xl font-bold">Information we collect</h1>
      <p className="mb-4">
