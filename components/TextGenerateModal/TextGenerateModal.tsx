      ...
      <Dialog as="div" className="relative z-10" onClose={() => setOpen(false)}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-full p-4 sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative w-full h-auto px-4 pt-10 pb-4 overflow-hidden text-left transition-all transform border-2 border-black shadow-xl sm:w-2/3 md:w-1/2 bg-primary dark:bg-lightblue ">
